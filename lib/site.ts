...
export const copy: Record<
  Locale,
  {
    nav: { features: string; process: string; pricing: string; faq: string; billing: string; cta: string };
    hero: {
      eyebrow: string;
      title: string;
      subtitle: string;
...
> = {
  en: {
    ...
    pain: {
      title: "Most service businesses are still leaking revenue through manual chaos.",
      subtitle:
    ...
    features: {
      title: "Built for operators who need a site that performs, not just one that exists.",
      items: [
        {
          title: "Bilingual UX",
    ...
    pricing: {
      ...
      subtitle: "Low launch monthly plans with a very small one-time implementation fee.",
      monthly: "/ month",
    ...
    form: {
      ...
      consent: "By sending this form, you agree to the Privacy Policy and Terms.",
      placeholders: {
        name: "Your name",
        email: "name@company.com",
        company: "Dexcore Services",
        service: "Camera installation",
        message: "We need a premium bilingual website with subscriptions and better lead flow."
      }
    },
    footer: {
    ...
    cookies: {
      ...
      body:
        "Dexcore uses essential cookies for core functionality and optional cookies for analytics and marketing preferences.",
    ...
    billingLookup: {
      ...
      body:
        "Enter the email used at checkout and Dexcore will try to locate your Stripe customer profile.",
  ...
  es: {
    ...
    pain: {
      title: "La mayoría de los negocios de servicios sigue perdiendo dinero por el caos manual.",
      subtitle:
    ...
    features: {
      title: "Hecho para operadores que necesitan un sitio que funcione, no uno que solo exista.",
      items: [
        {
          title: "UX bilingüe",
    ...
    pricing: {
      ...
      subtitle: "Planes mensuales de lanzamiento con una cuota de implementación muy baja por una sola vez.",
      monthly: "/ mes",
    ...
    form: {
      ...
      consent: "Al enviar este formulario aceptas la Política de Privacidad y los Términos.",
      placeholders: {
        name: "Tu nombre",
        email: "nombre@empresa.com",
        company: "Dexcore Services",
        service: "Instalación de cámaras",
        message: "Necesitamos un sitio premium bilingüe con suscripciones y mejor flujo de leads."
      }
    },
    footer: {
    ...
    cookies: {
      ...
      body:
        "Dexcore usa cookies esenciales para funciones básicas y cookies opcionales para analítica y marketing.",
    ...
    billingLookup: {
      ...
      body:
        "Escribe el correo que usaste en el checkout y Dexcore intentará encontrar tu perfil de Stripe.",
    ...
    status: {
      ...
      cancel: "Checkout cancelado. Puedes revisar los planes e intentar otra vez.",
